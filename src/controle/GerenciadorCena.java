...
public class GerenciadorCena {
    private Stage stage;
    Image icon = new Image(getClass().getClassLoader().getResourceAsStream("visao/img/icon.png")); // busca o icone do programa
    ...
    public void trocarCena(String fxmlFile) {
        try {
            ...
            //Font.loadFont(getClass().getResourceAsStream( "view/fontes/NomedaFonte.ttf"), 12); // adcionando fonte
            //scene.getStylesheets().add("/visao/Estilo.css"); // adicionando folhas de estilo css
