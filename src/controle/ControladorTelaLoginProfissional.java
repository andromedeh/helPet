...
public class ControladorTelaLoginProfissional extends ControladorBase implements Initializable {
    @FXML
    private AnchorPane AnchorPaneTelaLoginProfissional;
    @FXML
    ...
    @FXML
    private Button btnVoltar, btnVerSenha, btnLoginProfissional;
    @FXML
    ...
    @FXML
    void loginProfissional(ActionEvent event) {
