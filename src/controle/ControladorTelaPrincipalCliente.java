...
public class ControladorTelaPrincipalCliente extends ControladorBase implements Initializable {
  ...
  @FXML
  private Pane paneMenu, PaneConteudo, PaneCadastrarPet, PaneSolicitarConsulta, PaneVacinacao, PaneRemedios, PaneExames,
      PaneNotificacao, PaneFAQ;

  @FXML
  private Button btnCadastrarNovoPet, btnSolicitarConsulta, btnVacinacao, btnRemedios, btnExames, btnNotificacoes,
      btnFAQ, btnSair;
  ...
  public void visibilidadeTelas(boolean conteudo, boolean cadastroPet, boolean solicitarConsulta, boolean vacinacao,
    ...
    PaneSolicitarConsulta.setVisible(solicitarConsulta);
